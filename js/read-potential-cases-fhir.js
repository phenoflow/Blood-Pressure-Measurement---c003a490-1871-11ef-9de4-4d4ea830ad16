...
(async () => {
  ...
  await fs.writeFile("blood-pressure-measurement-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("blood-pressure-measurement-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
